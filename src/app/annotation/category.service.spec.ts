...
describe('CategoryService', () => {
  ...
  it('should properly convert a category to a brat entity', inject(
    [CategoryService],
    (service: CategoryService) => {
      const convertedAsEntities = service.getCategoriesAsEntityTypes(
        MOCK_CATEGORIES
      );
  ...
  it('getCategory should return CATEGORIES', inject(
    [CategoryService],
    (service: CategoryService) => {
  ...
  it('should allow to get categories for a certain project ID', inject(
    [CategoryService],
    (service: CategoryService) => {
  ...
  xit('should only allow authenticated users to call the categories service', inject(
    [CategoryService],
    (service: CategoryService) => {
  ...
  xit('should only return categories for projects associated with the user\'s level of permission', inject(
    [CategoryService],
    (service: CategoryService) => {
  ...
  xit('categories converted into entities should have entities capabilities', inject(
    [CategoryService],
    (service: CategoryService) => {
