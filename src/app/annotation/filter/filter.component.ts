...
export class FilterComponent implements OnInit {
  ...
  highlightFilter(): void {
    ...
    const liToHighlight: HTMLCollectionOf<HTMLElement> = document.getElementsByClassName('filterOption') as HTMLCollectionOf<HTMLElement>;
    for (let i = 0; i < liToHighlight.length; i++) {
