...
import { docData, colData, project, annotDoc } from "./brat-utils.mock";
...
describe("getDocDataFromAnnotatedDocument", () => {
  ...
  it("should create a DocumentData", () => {
    expect(BratUtils.getDocDataFromAnnotatedDocument(annotDoc.doc1)).toEqual(
      docData.doc1DocData
    );
  });
});
...
describe("getColDataFromProject", () => {
  ...
  it("should create a CollectionData", () => {
    expect(BratUtils.getColDataFromProject(project.proj1)).toEqual(
      colData.stdColData
    );
  });
});
...
describe("getAnnotatedDocumentfromDocData", () => {
  ...
  it("should create an annotated document", () => {
    expect(
      BratUtils.getAnnotatedDocumentfromDocData(
        docData.annotDocData,
        project.proj1,
        annotDoc.aDocInit
      )
