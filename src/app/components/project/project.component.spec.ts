...
describe('Projet', () => {
  ...
  //  Implementation de tests pour le bug #113
  describe('Test de couleur d\'ecriture', () => {
    it('Devrait retourner True car la couleur soumis est une couleur foncée', () => {
      // tslint:disable-next-line: no-unused-expression
      expect(projectComponent.choisirCouleurDeTexte('black')).toBeTruthy;
    });

    it('Devrait retourner False car la couleur soumis est une couleur non foncée', () => {
      // tslint:disable-next-line: no-unused-expression
      expect(projectComponent.choisirCouleurDeTexte('white')).toBeTruthy;
    });
  });
